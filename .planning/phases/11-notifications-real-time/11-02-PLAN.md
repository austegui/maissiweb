...
must_haves:
  ...
  key_links:
    ...
    - from: "src/app/page.tsx"
      to: "handleConversationsLoaded"
      via: "calls both onConversationsUpdated and onMessageAlert"
      pattern: "onConversationsUpdated.*onMessageAlert|onMessageAlert.*onConversationsUpdated"
---
