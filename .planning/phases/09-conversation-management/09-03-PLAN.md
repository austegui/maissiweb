...
- Render a container div with:
  - Title: "Etiquetas" (h1)
  - Back link: `← Volver al inbox` pointing to `/`
...
Note: The navigation link "Etiquetas" in the inbox header will be added in Plan 09-04 Task 1 when page.tsx is modified for status state management.
