...
**1g. Add navigation link for label management:**

Add a "Etiquetas" link next to the existing "Canned Responses" and "Settings" links in the header nav. Point it to `/admin/labels`.
  </action>
