# Requirements Archive: v2.0 Commercial-Grade Features
...
- [ ] **SEARCH-01**: Global search accessible via Cmd+K (or a search icon in the header) _(deferred to backlog)_
- [ ] **SEARCH-02**: Search finds contacts by name and phone number _(deferred to backlog)_
- [ ] **SEARCH-03**: Search finds conversations by contact name, phone number, or label _(deferred to backlog)_
- [ ] **SEARCH-04**: Message content search if Kapso API supports it _(deferred to backlog)_
...
- [ ] **SENTRY-01**: Sentry integrated for error tracking _(descoped from v2.0 -- revisit in future milestone)_
- [ ] **SENTRY-02**: Unhandled errors captured and reported to Sentry _(descoped from v2.0 -- revisit in future milestone)_
...
- Shipped: 50 (all in-scope requirements)
- Deferred: 4 (SEARCH-01 through SEARCH-04)
- Descoped: 2 (SENTRY-01, SENTRY-02)

---

## Milestone Summary

**Shipped:** 50 of 56 v2.0 requirements
